  ...
  return (
    <section className="relative min-h-[75vh] md:min-h-[85vh] flex items-center justify-center text-center bg-gd text-cream px-6 pt-28 md:pt-36 overflow-hidden">
      ...
      >
        ...
        >
          Enjoy luxury rooms with modern comfort at Sunvalley Homestay Coonoor.
          A peaceful stay perfect for solo travelers and families.
        </motion.p>
        ...
        >
          <Stat value="21" label="Guests Stay" />
          <Stat value="6" label="Rooms" />
          <Stat value="₹15k+" label="Packages Start" />
        </motion.div>
      </motion.div>
